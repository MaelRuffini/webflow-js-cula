...
export default function header() {
  ...
  mm.add(
    ...
    (context) => {
      ...
      links.forEach((item) => {
        let linkHoverTl = gsap
          .timeline({ paused: true })
          .to(
            item.querySelector('.link__arrow--relative'),
            {
              xPercent: 100,
              opacity: 0,
              duration: 0.3,
          ...
          .to(
            item.querySelector('.link__arrow--hover'),
            {
              xPercent: 100,
              opacity: 1,
              duration: 0.3,
